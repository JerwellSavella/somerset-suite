...
function InfoRow({ label, value }: { label: string; value: string | number | null }) {
    return (
        <div className="flex flex-col gap-1 border-b border-sidebar-border/70 py-3 last:border-b-0 dark:border-sidebar-border sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="mx-auto max-w-2xl space-y-6">
               ...
               <div className="rounded-xl border border-sidebar-border/70 p-6 dark:border-sidebar-border">
                    ...
                    <div className="grid gap-0">
                         ...
                         <InfoRow label="Phone Number" value={profile.phone_num} />
                         <InfoRow label="Date of Birth" value={formatDate(profile.birth_date)} />
                         <InfoRow label="Age" value={age} />
                         <InfoRow label="Date of Baptism" value={formatDate(profile.baptism_date)} />
                         ...
                         <InfoRow label="User Type" value={profile.user_type_desc} />
